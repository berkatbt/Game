  ...
  return (
    <div className="fixed flex flex-col bg-[#CBF3BB] min-w-screen h-screen flex justify-center items-center">
      ...
      <div className="relative size-1 flex flex-col items-center">
        ...
        ><span className="rubik-bubbles-regular text-[55px] text-[#CBF3BB] stroke-black-500"><Link to="/PlayGame">Mulai</Link></span></motion.button>
        <motion.button
        ...
        ><span className="rubik-bubbles-regular text-[55px] text-[#CBF3BB] hover:scale-102 stroke-black-500"><Link to="/credits">Credit</Link></span></motion.button>
      </div>
